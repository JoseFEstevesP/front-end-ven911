...
import { dataOrder, dataOrderVehicle, dataStatus } from '../../data/dataOrder';
...
const FilterVehicle = ({ isOpen, handelClose, handelFetch, url }) => {
	...
	const { filterOptions, handleChange, handleSubmit } = useFilter({
		...
		initForm: {
			...initForm,
			uidSite: site,
			orderProperty: dataOrderVehicle[0].value,
		},
		options,
		handelFetch,
	});
